                ...
                <div className="overflow-x-auto flex-1">
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100 font-semibold text-slate-700">
                            {isLoading ? (
                                <tr>
                                    <td colSpan={7} className="py-10 text-center text-sm text-slate-500 font-medium">Loading enquiries...</td>
                                </tr>
                            ) : filteredEnquiries.length === 0 ? (
                                <tr>
                                    <td colSpan={7} className="py-10 text-center text-sm text-slate-500 font-medium">No enquiries found.</td>
                                </tr>
                            ) : (
                                filteredEnquiries.map((lead, idx) => (
                                    ...
                                    >
                                        {/* Enquiry No */}
                                        <td className="py-3.5 px-5 text-slate-900 font-bold group-hover:text-emerald-600 transition-colors whitespace-nowrap">
                                            <div className="font-mono text-[14.5px] font-semibold text-slate-800 group-hover:text-emerald-600 tracking-tight">
                                                {lead.enquiryId}
                                            </div>
                                        ...
                                        <td className="py-3.5 px-5">
                                            <select
                                                ...
                                                className="text-[13.5px] font-semibold bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 hover:border-emerald-300 transition-all cursor-pointer shadow-2xs"
                                            >
                                        ...
                                        {/* Status */}
                                        <td className="py-3.5 px-5">
                                            <span className="inline-flex items-center text-[12.5px] font-bold bg-blue-50 text-blue-700 rounded-lg px-2.5 py-0.5 border border-blue-200/80 uppercase tracking-wide group-hover:bg-emerald-50 group-hover:text-emerald-700 group-hover:border-emerald-200 transition-colors">
                                                {lead.status}
                                            </span>
                                        </td>
