...
export default function BrandManagerAdmissionHub() {
    const { user } = useUser();
                                            ...
                                            <tr key={i} className="hover:bg-slate-50/50 transition-colors cursor-pointer" onClick={() => { setSelected360StudentId(adm._id); setIs360Open(true); }}>
                                                ...
                                                <td className="px-6 py-4 text-right flex items-center justify-end gap-2">
                                                    <button
                                                        ...
                                                        className="text-xs font-bold text-emerald-700 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-lg transition-colors border border-emerald-200 cursor-pointer"
                                                    >
                                                        Student 360
                                                    </button>
                                                    <button
