...
export default function FeeCollectionPage() {
  ...
  const handlePaymentSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && resData.success) {
        ...
        const updatedStudent = (freshRes.ok && freshData.success && freshData.data.length > 0)
          ? freshData.data[0]
          : selectedStudent;
  ...
  const generateInstallments = () => {
    ...
    const emiPrincipal = Math.max(0, (selectedStudent.finalFee || selectedStudent.totalCourseFee || 0) - upfrontPayments);
